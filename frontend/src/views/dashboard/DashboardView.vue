          ...
          >
            ...
            >
              ...
              <div
                :class="[
                  ...
                  getWidgetColor(getWidgetById(item.i)!.color).gradient,
                ]"
              />
            ...
            >
              ...
              <div class="flex-1 min-h-0 pt-2">
                ...
                <template v-else>
                  <div
                    class="h-full flex items-center justify-center text-foreground/40"
                  >
                    {{ $t("common.noData") }}
                  </div>
                </template>
                  ...
                  <table class="w-full">
                    <thead>
                      <tr class="border-b border-border">
                        <th
                          class="text-left py-2 font-medium text-foreground/40 uppercase"
                        >
                          {{ getWidgetById(item.i)!.group_by_field }}
                        </th>
                        <th
                          class="text-right py-2 font-medium text-foreground/40 uppercase"
                        >
                          {{ $t("dashboard.count") }}
                        </th>
                      </tr>
                    ...
                    >
                      ...
                      <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                          ...
                          <span
                            class="text-foreground/40 flex items-center gap-1 shrink-0"
                          >
                            <Clock class="size-3" />
            ...
            >
              ...
              <div class="flex-1 min-h-0 overflow-y-auto px-6 pb-6">
                ...
                >
                  <template
                    v-for="key in getWidgetById(item.i)!.config?.shortcuts ||
                    []"
                    :key="key"
                  >
                    <RouterLink
