        ...
        <CardContent class="p-4">
          <div v-if="testResult.success" class="space-y-2">
            <div class="flex items-center gap-2 text-success">
              ...
              >
                <TestTube2 class="size-3 mr-1" />
                {{ $t("accounts.testNumber", "Test Number") }}
              </Badge>
            </div>
            <div
              v-if="testResult.warning"
              class="flex items-start gap-2 p-2 rounded-lg bg-warning/50 border border-warning"
            >
            ...
            <div class="mt-4 border-t pt-4 border-border/40">
              <h4
                class="font-semibold text-muted-foreground uppercase tracking-wider mb-3"
              >
              ...
              >
                ...
                <div v-if="testResult.verified_name" class="space-y-1">
                  ...
                  <span
                    class="font-semibold block text-foreground truncate"
        ...
        <CardContent class="space-y-3">
          <div>
            ...
            <div class="flex items-center gap-2 mt-1">
              <code
                class="px-2 py-1 bg-muted rounded font-mono flex-1 truncate"
                >{{ webhookUrl }}</code
              >
              <IconButton
                :icon="Copy"
          ...
          <div>
            <Label class="text-muted-foreground">{{
              $t("accounts.verifyToken", "Verify Token")
            }}</Label>
            <div class="flex items-center gap-2 mt-1">
              <code
                class="px-2 py-1 bg-muted rounded font-mono flex-1 truncate"
                >{{ account?.webhook_verify_token }}</code
              >
              <IconButton
                :icon="Copy"
                label="Copy"
                @click="copyToClipboard(account?.webhook_verify_token || '')"
              />
            </div>
          </div>
        </CardContent>
            ...
            >
              ...
              <li>
                {{
                  $t(
                    "accounts.setupStep5",
                    "Configure the webhook URL and verify token in Meta dashboard",
                  )
                }}
              </li>
              <li>
