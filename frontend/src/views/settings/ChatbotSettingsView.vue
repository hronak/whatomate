        ...
        <Tabs default-value="messages" class="w-full">
          ...
          <TabsContent value="messages">
            ...
            <div v-if="orgID" class="mt-4">
              <AuditLogPanel
                :key="messagesLogKey"
                resource-type="settings.chatbot.messages"
                :resource-id="orgID"
              />
            </div>
          </TabsContent>
          ...
          <TabsContent value="agents">
            ...
            <div v-if="orgID" class="mt-4">
              <AuditLogPanel
                :key="agentsLogKey"
                resource-type="settings.chatbot.agents"
                :resource-id="orgID"
              />
            </div>
          </TabsContent>
          ...
          <TabsContent value="hours">
            ...
            <div v-if="orgID" class="mt-4">
              <AuditLogPanel
                :key="hoursLogKey"
                resource-type="settings.chatbot.hours"
                :resource-id="orgID"
              />
            </div>
          </TabsContent>
          ...
          <TabsContent value="sla">
            ...
            <div v-if="orgID" class="mt-4">
              <AuditLogPanel
                :key="slaLogKey"
                resource-type="settings.chatbot.sla"
                :resource-id="orgID"
              />
            </div>
          </TabsContent>
          ...
          <TabsContent value="ai">
            ...
            <div v-if="orgID" class="mt-4">
              <AuditLogPanel
                :key="aiLogKey"
                resource-type="settings.chatbot.ai"
                :resource-id="orgID"
              />
            </div>
          </TabsContent>
