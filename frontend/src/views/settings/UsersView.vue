...
async function createUser() {
  ...
  try {
    await usersStore.createUser({
      ...
      is_super_admin:
        isSuperAdmin.value && formData.value.is_super_admin ? true : undefined,
    });
    toast.success(
    ...
    >
      <template #actions>
        <Button variant="outline" size="sm" @click="copyInviteLink"
          ><Link class="size-4 mr-2" />{{ $t("users.copyInviteLink") }}</Button
        >
        <Button
          v-if="
        ...
        <Button variant="outline" size="sm" @click="openCreateDialog"
          ><Plus class="size-4 mr-2" />{{ $t("users.addUser") }}</Button
        >
      </template>
    </PageHeader>
              ...
              <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex items-center gap-3 flex-wrap">
                  ...
                  <label class="flex items-center gap-2">
                    <Switch
                      :checked="onlineOnly"
                      @update:checked="onlineOnly = $event"
                    />
              ...
              >
                  ...
                  >
                    ...
                    <div class="min-w-0">
                      <div class="flex items-center gap-2">
                        ...
                        <Badge v-if="user.is_member" variant="secondary">{{
                          $t("users.member")
                        }}</Badge>
                      </div>
                    </div>
                ...
                <template #cell-actions="{ item: user }">
                  <div class="flex items-center justify-end gap-1">
                    ...
                    >
                      <component
                        :is="user.is_member ? UserMinus : Trash2"
    ...
    <Dialog v-model:open="isAddExistingOpen">
      <DialogContent class="max-w-md">
        ...
        <DialogFooter>
          ...
          >
            <Spinner v-if="isAddExistingSubmitting" class="size-4 mr-2" />
            {{ $t("users.addExistingUser") }}
          </Button>
        </DialogFooter>
      </DialogContent>
