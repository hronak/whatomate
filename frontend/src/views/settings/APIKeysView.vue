...
const {
  ...
  openDeleteDialog,
  closeDeleteDialog,
} = useCrudState<APIKey, Record<string, never>>({});
              ...
              >
                ...
                <template #cell-status="{ item: key }">
                  <div class="flex items-center gap-2">
                    <Switch
                      :checked="key.is_active && !isExpired(key.expires_at)"
                      :disabled="isExpired(key.expires_at)"
                      @update:checked="toggleActive(key)"
                    />
                ...
                <template #cell-actions="{ item: key }">
                  <div class="flex items-center justify-end gap-1">
                    ...
                    <IconButton
                      v-if="canDelete"
                      :icon="Trash2"
                      :label="$t('apiKeys.deleteApiKeyLabel')"
                      variant="ghost"
