...
function openEditDialog(action: CustomAction) {
  baseOpenEditDialog(action, (a) => ({
    ...
    config: {
      ...
      body: a.config.body || "",
      open_in_new_tab: a.config.open_in_new_tab !== false,
      code: a.config.code || "",
    },
  }));
}
...
async function saveAction() {
  ...
  try {
    ...
    if (editingItem.value) {
      await customActionsService.update(editingItem.value.id, payload);
      toast.success(
...
async function deleteAction() {
  ...
  try {
    await customActionsService.delete(itemToDelete.value.id);
    await fetchActions();
    toast.success(
    ...
    <Dialog v-model:open="isDialogOpen">
      <DialogContent class="max-h-[90vh] overflow-y-auto">
          ...
          <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2">
              <Button
                ...
                ><component :is="iconOpt.icon" class="size-5"
              /></Button>
            </div>
          </div>
          <div class="space-y-2">
        ...
        <DialogFooter>
          ...
          <Button @click="saveAction" :disabled="isSubmitting"
