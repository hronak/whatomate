...
<template>
  <div class="flex flex-col h-screen bg-muted/30">
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <!-- Right panel -->
      <Card
        class="w-[420px] min-w-0 border-y-0 border-r-0 rounded-none shrink-0"
      >
        ...
        <ScrollArea v-else orientation="vertical" class="flex-1">
          <div class="p-4 space-y-4 min-w-0">
            ...
            <Collapsible v-model:open="completionConfigOpen">
              <CollapsibleTrigger
                class="flex items-center justify-between w-full py-1 font-medium"
              >
                    ...
                    <div class="space-y-2">
                      ...
                      >
                        <Input
                          ...
                          @update:model-value="
                            (v: string | number) =>
                              updateCompletionHeaderKey(String(key), String(v))
                          "
                          placeholder="Key"
                          class="h-6 flex-1"
                        />
