...
const {
  ...
  openDeleteDialog,
  closeDeleteDialog,
} = useCrudState<AIContext, Record<string, never>>({});
              ...
              >
                ...
                <template #cell-actions="{ item: context }">
                  <div class="flex items-center justify-end gap-1">
                    <RouterLink :to="`/chatbot/ai/${context.id}`"
                      ><IconButton
                        :icon="Pencil"
                        :label="$t('aiContexts.editContextLabel')"
                        class="size-8"
                    /></RouterLink>
                    <IconButton
                      :icon="Trash2"
                      :label="$t('aiContexts.deleteContextLabel')"
