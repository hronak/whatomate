...
const {
  ...
  openDeleteDialog,
  closeDeleteDialog,
} = useCrudState<KeywordRule, Record<string, never>>({});
            ...
            <CardContent>
              ...
              >
                <template #cell-keywords="{ item: rule }">
                  <RouterLink
                    :to="`/chatbot/keywords/${rule.id}`"
                    class="flex flex-wrap gap-1 text-inherit no-underline hover:opacity-80"
                  >
                    <Badge
                ...
                <template #cell-match_type="{ item: rule }">
                  <Badge
                    class="capitalize bg-blue-500/20 text-blue-400 border-transparent"
                  ...
                  <Badge
                    :class="
                      rule.response_type === 'transfer'
                        ...
                        : 'bg-purple-500/20 text-purple-700 border-transparent dark:bg-purple-100 dark:text-purple-400'
                    "
                  >
                    {{
                      rule.response_type === "transfer"
                ...
                <template #cell-actions="{ item: rule }">
                  <div class="flex items-center justify-end gap-1">
                    <RouterLink :to="`/chatbot/keywords/${rule.id}`"
                      ><IconButton
                        :icon="Pencil"
                        :label="$t('keywords.editRuleLabel')"
                        class="size-8"
                    /></RouterLink>
                    <IconButton
                      :icon="Trash2"
                      :label="$t('keywords.deleteRuleLabel')"
