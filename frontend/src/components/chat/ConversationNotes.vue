...
import { StickyNote, Pencil, Trash2, X, Check, Send } from "@lucide/vue";
  ...
  >
    ...
    >
      <div class="flex items-center gap-2">
        <div
          class="size-7 rounded-lg bg-amber-500/15 flex items-center justify-center"
        >
        ...
        <Badge
          ...
          class="bg-warning/20 text-warning border-0 px-1.5 py-0"
        >
          {{ notesStore.notes.length }}
        </Badge>
      </div>
    ...
    >
      <div class="space-y-3">
            ...
            <template v-else>
              <div class="flex items-start gap-2.5 mt-1">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p
                    class="text-foreground/60 leading-relaxed whitespace-pre-wrap wrap-break-word"
                  >
                    {{ note.content }}
                  </p>
                </div>
        ...
        >
          <div
            class="size-12 rounded-xl bg-warning/10 flex items-center justify-center mb-3"
          >
            <StickyNote class="size-6 text-warning/50" />
          </div>
          <p class="font-medium text-foreground/40 mb-1">
            {{ t("chat.noNotes") }}
          </p>
