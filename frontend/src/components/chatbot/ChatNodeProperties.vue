  ...
  <div class="space-y-4 p-4">
    ...
    <template v-if="isTextNode">
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateTextBody(String(String(v) ?? ''))
          "
      ...
      <template v-if="node.type === 'prompt'">
        ...
        <div class="space-y-1.5">
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateConfig('validation_regex', String(v))
            "
            placeholder="^[0-9]+$"
            class="h-8 font-mono"
          />
        ...
        <div class="space-y-1.5">
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateConfig('validation_error', String(v))
            "
    ...
    <template v-if="node.type === 'buttons'">
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateConfig('body', String(v))
          "
        ...
        >
          <div class="flex items-center gap-1">
            ...
            <Input
              ...
              @update:model-value="
                (v: string | number) =>
                  updateButton(Number(idx), 'title', String(v))
              "
          ...
          <Input
            :model-value="btn.id || ''"
            @update:model-value="
              (v: string | number) => updateButton(Number(idx), 'id', String(v))
            "
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateButton(Number(idx), 'url', String(v))
            "
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateButton(Number(idx), 'phone_number', String(v))
            "
    ...
    <template v-if="node.type === 'api_call'">
      ...
      <div class="space-y-1.5">
        ...
        >
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateResponseMappingKey(String(key), String(v))
            "
            placeholder="var_name"
            class="h-7 flex-1 font-mono"
          />
          <Input
            :model-value="String(val)"
            @update:model-value="
              (v: string | number) =>
                updateResponseMappingValue(String(key), String(v))
            "
      ...
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateConfig('message_template', String(v))
          "
    ...
    <template v-if="node.type === 'condition'">
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateConfig('expression', String(v))
          "
    ...
    <template v-if="node.type === 'transfer'">
      ...
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateConfig('notes', String(v))
          "
    ...
    <template v-if="node.type === 'end'">
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateConfig('message', String(v))
          "
    ...
    <template v-if="node.type === 'whatsapp_flow'">
      <div class="space-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('flow_id', String(v))
          "
      ...
      <div class="space-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('header', String(v))
          "
          class="h-8"
        />
      </div>
      ...
      <div class="space-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('cta', String(v))
          "
    ...
    >
      ...
      <Input
        ...
        @update:model-value="
          (v: string | number) => updateConfig('skip_condition', String(v))
        "
