...
<template>
  <div class="mt-1 space-y-1">
    <button
      ...
      :key="btn.id"
      class="w-full bg-white dark:bg-secondary text-primary font-medium py-2.5 px-4 rounded-lg shadow-xs border-0 flex items-center justify-center gap-1.5 transition-colors"
      :class="{
