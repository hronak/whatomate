...
<template>
  <div class="flex-1 flex h-full">
    ...
    <div class="flex-1 flex flex-col min-w-0">
      ...
      <div
        class="flex-1 flex items-center justify-center p-6 bg-gray-100 dark:bg-gray-900"
      >
        <!-- Device bezel -->
        <div
          ...
          >
            ...
            >
              ...
              <div class="flex items-center gap-1">
                ...
                <!-- battery -->
                <svg width="22" height="10" viewBox="0 0 28 12" fill="none">
                  <rect
                    x="0.5"
                    y="0.5"
                    width="24"
            ...
            <ScrollArea ref="chatScrollRef" class="flex-1 p-4 whatsapp-bg">
              <div class="gap-y-3">
                ...
                <div
                  v-if="
                    isWaitingForInput &&
                    currentStep?.message_type === 'whatsapp_flow'
                  "
                ...
                >
                  <div class="max-w-[85%]">
                    ...
                    <p class="text-gray-500 mt-1 italic">
                      Simulated: clicks complete the flow
                    </p>
                  </div>
                </div>
            ...
            <PreviewInputBar
              ...
              :disabled="
                !isWaitingForInput ||
                expectedInputType === 'button' ||
                expectedInputType === 'whatsapp_flow'
              "
