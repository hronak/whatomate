  ...
  <div class="gap-y-4 p-4">
          ...
          <Textarea
            ...
            @update:model-value="
              (v: string | number) =>
                updateConfigEntries(
                  String(v)
                    ? { greeting_text: String(v), audio_file: undefined }
                    : { greeting_text: String(v) },
                )
            "
    ...
    <template v-if="node.type === 'menu'">
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) =>
              updateConfig('timeout_seconds', parseInt(String(v)) || 10)
          "
          class="h-8"
          min="1"
          max="60"
      ...
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) =>
              updateConfig('max_retries', parseInt(String(v)) || 3)
          "
          class="h-8"
          min="1"
          max="10"
      ...
      <div class="gap-y-1.5">
        ...
        >
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateMenuOption(String(digit), 'label', String(v))
            "
            placeholder="Label"
            class="h-7 flex-1"
          />
    ...
    <template v-if="node.type === 'gather'">
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) =>
              updateConfig('max_digits', parseInt(String(v)) || 10)
          "
          class="h-8"
          min="1"
          max="20"
      ...
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('terminator', String(v))
          "
          class="h-8"
        />
      </div>
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('store_as', String(v))
          "
    ...
    <template v-if="node.type === 'http_callback'">
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('url', String(v))
          "
      ...
      <div class="gap-y-1.5">
        ...
        >
          <Input
            ...
            @update:model-value="
              (v: string | number) => updateHeaderKey(String(key), String(v))
            "
            placeholder="Key"
            class="h-7 flex-1"
          />
          <Input
            ...
            @update:model-value="
              (v: string | number) => updateHeaderValue(String(key), String(v))
            "
            placeholder="Value"
            class="h-7 flex-1"
          />
      ...
      <div class="gap-y-1.5">
        ...
        <Textarea
          ...
          @update:model-value="
            (v: string | number) => updateConfig('body_template', String(v))
          "
      ...
      <div class="gap-y-1.5">
        ...
        <Input
          ...
          @update:model-value="
            (v: string | number) => updateConfig('response_store_as', String(v))
          "
    ...
    <template v-if="node.type === 'transfer'">
      ...
      <div class="gap-y-2 mt-3">
        ...
        >
          <button
            class="w-full flex items-center justify-between px-3 py-1.5 font-medium hover:bg-muted/50"
            @click="
              updateCallbackField(
                event,
                '_expanded',
          ...
          >
            <div class="gap-y-1 pt-2">
              ...
              <Input
                ...
                @update:model-value="
                  (v: string | number) =>
                    updateCallbackField(event, 'url', String(v))
                "
            ...
            <div class="gap-y-1">
              ...
              >
                <Input
                  ...
                  @update:model-value="
                    (v: string | number) =>
                      updateCallbackHeaderKey(event, String(key), String(v))
                  "
                  placeholder="Key"
                  class="h-6 flex-1"
                />
                <Input
                  ...
                  @update:model-value="
                    (v: string | number) =>
                      updateCallbackHeaderValue(event, String(key), String(v))
                  "
                  placeholder="Value"
                  class="h-6 flex-1"
                />
            ...
            >
              ...
              <Textarea
                ...
                @update:model-value="
                  (v: string | number) =>
                    updateCallbackField(event, 'body_template', String(v))
                "
                :placeholder="`{&quot;phone&quot;: &quot;{{caller_phone}}&quot;, &quot;transfer_id&quot;: &quot;{{transfer_id}}&quot;}`"
                class="min-h-[50px] font-mono resize-none"
              />
            </div>
          </div>
        </div>
        ...
        <div v-if="config._vars_expanded" class="px-3 pb-2 border-t">
          <div class="flex flex-wrap gap-1 pt-2">
            <code
              ...
              :key="v"
              class="bg-muted px-1.5 py-0.5 rounded cursor-pointer hover:bg-muted/80"
              :title="
      ...
      <div class="gap-y-1.5">
        ...
        >
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateScheduleEntry(Number(idx), 'start_time', String(v))
            "
            class="h-8 w-28"
          />
          ...
          <Input
            ...
            @update:model-value="
              (v: string | number) =>
                updateScheduleEntry(Number(idx), 'end_time', String(v))
            "
            class="h-8 w-28"
          />
        </div>
